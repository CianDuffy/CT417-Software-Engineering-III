...
/**
 * Created by CianDuffy on 18/09/2016
 */
public class StudentRegistrationSystemDriver
{
    public static void main( String[] args )
    {
        ...
        testStudent1 = new Student("Nick Faldo", actionManager.dateTimeFromString("18/07/1957"), "13300001");
        testStudent2 = new Student("John Daly", actionManager.dateTimeFromString("01/01/1994"), "13300002");
        testStudent3 = new Student("Tiger Woods", actionManager.dateTimeFromString("02/02/1995"), "13300003");
        testStudent4 = new Student("Ernie Els", actionManager.dateTimeFromString("30/07/1994"), "13300004");
        testStudent5 = new Student("Phil Mickelson", actionManager.dateTimeFromString("16/03/1994"), "13300005");
        testStudent6 = new Student("Henrik Stenson", actionManager.dateTimeFromString("03/12/1995"), "13300006");
        testStudent7 = new Student("Miguel Ángel Jíminez", actionManager.dateTimeFromString("12/10/1995"), "13300007");
        testStudent8 = new Student("Vijay Singh", actionManager.dateTimeFromString("10/05/1994"), "13300008");
        ...
        DateTime startDateTime = actionManager.dateTimeFromString("07/09/2016");
        DateTime endDateTime = actionManager.dateTimeFromString("10/05/2017");
